...
<head>
	<meta charset="utf-8">
	<title>CAR STAFF | UPDATE DETAILS</title>
            ...
            <div class="displayUpdate scroll">
            	...
            	<div class="div2">
					...
					<div style="padding-top: 25px;" align="center">
                        ...
                        <a href="carStaffHome.php">  <input style="color:black;" type="button" name="Cancel" value="CANCEL"></a>
					</div>
				</form>
				</div>
		<?php } } ?>	
...
<?php
	...
	if(isset($_POST["update"]))
    {
		...
		$querystring="UPDATE staff SET Full_name='$name', age='$age', Email='$email', phn_no='$phone_num', Address='$address' WHERE u_name = '$staffId' AND domain = 'car_staff'";
	   	mysqli_query($conn,$querystring);
		echo'<script>alert("PROFILE HAS BEEN UPDATED SUCCESFULY!");</script>';
		echo '<script>window.location= "carStaffHome.php";</script>';
	}	
