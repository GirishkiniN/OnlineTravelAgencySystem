    ...
    <div class="full_sht">
        ...
        <div class="cntnt" >
            ...
            <div class="display scroll">
                ...
                <div>
                <img class="mySlides" src="https://www.autoeurope.com/default/assets/Image/best-rates-post.jpg" style="width:100%; height: 350px;">
                    <img class="mySlides" src="https://miro.medium.com/max/975/1*eY0kolIv3vFuyqK5LTZ3XA.png" style="width:100%;height: 350px;">
                    <img class="mySlides" src="https://media-cldnry.s-nbcnews.com/image/upload/newscms/2019_13/2798361/190325-rental-cars-cs-229p-2798361.jpg" style="width:100%;height: 350px;">
                ...
                <div class="outer">
                    ...
                    <div  style="width:270px;height:200px;border:1px solid #000; background-color: springgreen; margin-left:45px;">
                                ...
                                <div>
                                    <center><p style="margin-top: 30px;">TOTAL NO. OF CARS</p></center><br>
                                        <center>
                                            <?php
                                                $conn=mysqli_connect("localhost","root","","projectmeteor");        
                                                ...
                                                echo"$rows";
                                            ?>
                                            <p style="padding-top: 10px;"><center><a href="viewcar.php"><button>VIEW MORE</button></a></center></p>  
                                        </center>
                                </div>
                    </div>
                    ...
                    <div  style="width:270px;height:200px;border:1px solid #000; background-color: deepskyblue; margin-left:45px;">
                         ...
                         <div>
                             <center><p style="margin-top: 30px;">TOTAL NO. OF CAR BOOKING</p></center><br>
                                    <center>
                                        <?php
                                            $conn=mysqli_connect("localhost","root","","projectmeteor");        
                                            $query = "SELECT * FROM `cabbookings`";
                                            $result = mysqli_query($conn,$query) or die(mysql_error());
                                            $rows = mysqli_num_rows($result);
                                            echo"$rows";
                                        ?> 
                                        <p style="padding-top: 10px;"><center><a href="carBookings.php"><button>VIEW MORE</button></a></center></p>   
                                    </center>
                        </div>
                    </div>
                                ...
                                <center><p style="margin-top: 30px;">TOTAL NO. OF BOOKINGS TODAY</p></center><br>
                                    <center>
                                        <?php
                                            ...
                                            $conn=mysqli_connect("localhost","root","","projectmeteor");        
                                            $query = "SELECT * FROM `cabbookings` WHERE date='$todayDate'";
                                            $result = mysqli_query($conn,$query) or die(mysql_error());
                                            $rows = mysqli_num_rows($result);
                                            echo"$rows";
                                        ?>    
