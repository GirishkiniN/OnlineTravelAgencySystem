...
<head>
	<meta charset="utf-8">
	<title>PACKAGE STAFF | UPDATE DETAILS</title>
...
<?php
	...
	if(isset($_POST["update"]))
    {
		...
		$querystring="UPDATE staff SET Full_name='$name', age='$age', Email='$email', phn_no='$phone_num', Address='$address' WHERE u_name = '$staffId' AND domain = 'PACKAGE'";
	   	mysqli_query($conn,$querystring);
		echo'<script>alert("PROFILE HAS BEEN UPDATED SUCCESFULY!");</script>';
		echo '<script>window.location= "packagestf.php";</script>';
	}	
