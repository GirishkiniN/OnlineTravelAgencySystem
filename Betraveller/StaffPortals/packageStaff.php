...
<head>
    <meta charset="utf-8">
    <title>BEE TRAVELLER | PACKAGE STAFF</title>
            ...
            <div class="col-lg-6">
                <div class="card1 pb-5">
                    <div class="row px-3 justify-content-center mt-4 mb-5 border-line"> 
                        <img src="https://touroperatorsinshimla.files.wordpress.com/2014/11/nainital-tour-package.jpg" class="image"> 
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
