...
<body>
    ...
    <div class="full_sht">
        ...
        <div class="cntnt" >
            ...
            <div class="display scroll" style="background-color: #FAFAD2;">
          ...
          <br>
          <h1><center>BUS DRIVER DETAILS</center></h1>
          <br>
        <table>
        <tr>
            <th>DRIVER ID</th>
        ...
        <?php
            ...
            <tr>
                ...
                <td><img src="image/<?php echo $rows['d_photo'];?>" width="35px" height="35px"></td>
                ...
                <td><a href="viewDriverDetailsInfo.php?d_id=<?php echo $rows['d_u_name'];?>"><button type="button" class="button">UPDATE</button></a></td>
            </tr>
        <?php  } ?>    
    </table>
