...
<head>
    <meta charset="utf-8">
    <title>BEE TRAVELLER | BUS STAFF</title>
            ...
            <div class="col-lg-6">
                <div class="card1 pb-5">
                    <div class="row px-3 justify-content-center mt-4 mb-5 border-line"> 
                        <img src="https://t4.ftcdn.net/jpg/02/69/47/51/360_F_269475198_k41qahrZ1j4RK1sarncMiFHpcmE2qllQ.jpg" class="image"> 
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
