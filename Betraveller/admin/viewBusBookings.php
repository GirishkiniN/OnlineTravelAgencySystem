     ...
     <div class="full_sht">
        ...
        <div class="cntnt" >
            ...
            <div class="display scroll">
                <form action="" method="POST">
                 <h1 style="color:white;"><center><b>BUS BOOKINGS</b></center></h1><br>   
        ...
        <table id="myTable">
            ...
            <?php
                ...
                if($rows==0)
                {
                    echo"<tr><td colspan='8'>NO BUSES LEAVING TODAY</td></tr>";
                }
                else
                {   
            ...
            <tr>
                ...
                <td><a href="viewBusBookingsInfo.php?bus_id=<?php echo $rows['busID'];?>"><button type="button" class="button">VIEW >> </button></a></td>
            </tr>
            <?php
                } }
            ?>  
