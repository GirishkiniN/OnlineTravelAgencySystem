<!DOCTYPE html>
<head>
    <title>ADMIN | BUS BOOKINGS</title>
...
<body>
    ...
    ?>
     <div class="full_sht">
        ...
        <h1 style="color:white;"><center><b>LIST OF BOOKINGS IN BUS NO. <?php echo $busID; ?> </b></center></h1><br>
        <br>
        <center><input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for Booking Dates.." title="Type in a name"></center>
        <br>
        <table id="myTable">
            <tr class="header">
                <th>DATE</th>
            ...
            <?php
                ...
                $sql = "SELECT * FROM busbookings WHERE busid = '$busID'";
                $result = $conn->query($sql);
                $rows = mysqli_num_rows($result);
                if($rows==0)
                {
                    echo"<tr><td colspan='8'>NO BOOKINGS SO FAR ...</td></tr>";
                }
                else
                {
            ...
            <tr>
                ...
                <td><?php echo $rows['passengers'];?></td>
                <td><?php echo $rows['origin'];?></td>
                <td><?php echo $rows['destination'];?></td>
                <td><?php echo $rows['cancelled'];?></td>
