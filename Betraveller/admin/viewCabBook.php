...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `cabbookings` WHERE CONCAT(`bookingID`, `username`, `date`, `cancelled`, `origin`, `destination`, `carID`) LIKE '%".$valueToSearch."%'";
...
<head>
    <title>ADMIN | CAB BOOKING DETAILS</title>
    ...
    ?>
     <div class="full_sht">
        ...
        <div class="cntnt" >
            ...
            <h1 style="color:white;"><center><b>VIEW CAR BOOKING</b></center></h1><br><br>
