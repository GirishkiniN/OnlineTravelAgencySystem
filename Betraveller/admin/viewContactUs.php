     ...
     <div class="full_sht">
        ...
        <div class="cntnt" >
            ...
            <div class="display scroll">
                ...
                <h1 style="color:white;"><center><b>VIEW CUSTOMER FEEDBACK</b></center></h1><br><br>
        <br>
        <center><input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for Customer Names.." title="Type in a name"></center>
        <br>
        <table id="myTable">
            <tr class="header">
            ...
            <?php
                ...
                if($rows==0)
                {
                    echo"<tr><td colspan='8'>NO COMPLAINTS SO FAR...</td></tr>";
                }
                else
                {   
