...
<html lang="en">
	...
	<head>
		...
		<title>BeeTraveller | E-Ticket</title>
		...
		<div class="col-sm-12 generateTicket">
			...
			<div class="importantInfo">
				...
				<div class="col-sm-10">
					...
					<br><br>
					<center><button style="color:red;" onclick="printpage()">Print this page</button>
						<script>
							function printpage()
							{
...
<?php
	...
	$status = "Booked";
	$bookingDataInsertSQL = "INSERT INTO `busbookings`(username,date,cancelled,origin,destination,passengers,busid,status,Date_of_leaving) VALUES('$user','$dateFormatted','no','$origin','$destination','$totalPassengers','$busID','$status','$datePass')";
