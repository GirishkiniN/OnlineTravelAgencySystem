...
<html lang="en">
	...
	<head>
		...
		<title>BeeTraveller | Payment</title>
		...
		<div class="col-sm-12 paymentWrapper">
			...
			<div class="col-sm-6">
				...
				<div class="col-sm-12">
					...
					<input type="text" class="input" name="cardNumber" placeholder="Enter the card number" id="cardNumber" required/>
				...
				<div class="col-sm-12">
					...
					<input type="text" class="input" name="nameOnCard" placeholder="Enter the name of the card holder" id="nameOnCard" required/>
				...
				<div class="col-sm-6">
					...
					<input type="password" class="inputSmall" name="cvv" placeholder="CVV" id="cvv" required/>
					
				</div>
				
				<div class="col-sm-6">
					
					<input type="text" class="inputSmall" name="expiry" placeholder="MM/YY" id="cardExpiry" required/>
