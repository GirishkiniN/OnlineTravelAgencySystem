...
<html lang="en">
	...
	<head>
		...
		<title>BeeTraveller | Receipt</title>
		...
		<div class="col-sm-12 generateReceipt">
			...
			<div class="commonHeader">
				...
				<div class="col-sm-10 boxCenter"> <!-- outboundFlight Box -->
					...
					<div class="col-sm-2 borderRight text-center" style="margin:0px -16px 0px -10px">
					...
					<div class="col-sm-2 borderRight text-center" style="margin:0px -20px 0px -20px">
					...
					<div class="col-sm-2 borderRight text-center" style="margin:0px -20px 0px -10px">
					...
					<div class="col-sm-2 borderRight text-center" style="margin:0px -20px 0px -10px">
						...
						<div class="departsSubscript">
							...
							<?php echo 97615596100 ?>
							
						</div>
						
					</div> <!-- col-sm-4 -->
					
					<div class="col-sm-2 text-center" style="margin:0px -20px 0px -10px">
					...
					<div class="col-sm-10 boxCenter">
						...
						<div class="col-sm-3">
							...
							<div class="serialNo text-center">
								...
								<span class="rupee">₹</span><?php echo $dis." x 5.5"." = ";?>
								<span class="rupee">₹</span><?php echo $distFare = $dis*5.5; ?>
								...
								<span class="rupee">₹</span><?php echo $dis." x 8.75"." = ";?>
								<span class="rupee">₹</span><?php echo $distFare = $dis*8.75; ?>
								...
								<span class="rupee">₹</span><?php echo $dis." x 13.25"." = ";?>
								<span class="rupee">₹</span><?php echo $distFare = $dis*13.25; ?>
						...
						<div class="col-sm-3">
							...
							<div class="serialNo text-center">
								...
								<span class="rupee">₹</span><?php echo $dateDiff." x 160"." = ";?>
								<span class="rupee">₹</span><?php echo $timeFare = $dateDiff*160; ?>
								...
								<span class="rupee">₹</span><?php echo $dateDiff." x 180"." = ";?>
								<span class="rupee">₹</span><?php echo $timeFare = $dateDiff*180; ?>
								...
								<span class="rupee">₹</span><?php echo $dateDiff." x 230"." = ";?>
								<span class="rupee">₹</span><?php echo $timeFare = $dateDiff*230; ?>
...
<button style="color:red;" onclick="printpage()">Print this page</button>
<script>
	function printpage()
	{
