...
<html lang="en">
	...
	<head>
		...
		<title>BeeTraveller | Forgot Password</title>
	...
	<body>
		...
		<div class="forgotPassword">
			...
			<div class="col-sm-6 col-sm-offset-3">
				...
				<div class="containerBox" style="height: 300px;">
				...
				<form action="resetLinkSent.php" method="POST">
					...
					<label for="email">Enter the User_ID of your account:</label>
					<input type="text" class="input" name="userid" placeholder="Enter userID here" required>
