...
<html lang="en">
	...
	<head>
		...
		<title>BeeTraveller | Bus Search</title>
	...
	<body>
		...
		<?php
			...
			$sql = "SELECT * FROM bus WHERE origin='$origin' AND destination='$destination' AND Date_of_leaving='$date' ORDER BY seatsAvailable DESC";
		...
		?>
			<div class="noOfBus">
				<?php echo $rowcount ." buses found leaving on ".$date ."";
		...
		<div class="searchFlights">
			...
			<div class="noFlights">
				...
				No buses found on <?php echo $date;?> !!. 
