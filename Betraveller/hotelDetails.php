...
<html lang="en">
	...
	<head>
		...
		<title>BeeTraveller | Package Details</title>
			...
			<div class="col-sm-12 listItem">
				...
				<div class="col-sm-8 leftBox">
					...
					<div class="col-sm-12 imageContainer">
						...
						<img src="admin/image/package/<?php echo $row["mainImage"]; ?>" alt="Image not found" />
				...
				<div class="col-sm-4 rightBox borderLeft">
					...
					<div class="col-sm-7 text-center">
						...
						<div class="col-sm-12 starContainer" style="margin-left:80px;">
					...
					<div class="col-sm-12 amenities text-center">
						...
						<ul>
							...
							<?php if($row["parking"]=="Yes") {?>
								<li class="fa fa-bed icons" id="parking"></li>
							<?php } ?>
