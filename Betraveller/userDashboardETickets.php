...
<html lang="en">
	...
	<head>
		...
		<title>BeeTraveller | Dashboard</title>
		...
		<div class="container-fluid">
			...
			<div class="col-sm-7 containerBoxRight text-left">
				...
				<?php 
					...
					$flightBookingsSQL = "SELECT COUNT(*) FROM `hotelbookings` WHERE Username='$user' AND cancelled='no'";
				...
				<div class="col-sm-12 tickets">
					...
					<select class="input" name="ticketTypeSelector" id="ticketTypeSelector"/>
						...
						<option value="flightTickets">Package Tickets (<?php echo $noOfFlightBookings[0]; ?>)</option>
				...
				<div class="col-sm-12 ticketTableContainer pullABitLeft" id="busTicketsWrapper">
						...
						<table class="table table-responsive">
							<thead>
								<tr>
									<th class="tableHeaderTags text-center" style="vertical-align: middle;">Date of Booking</th>
									<th class="tableHeaderTags text-center" style="vertical-align: middle;">BUS NO.</th>
									...
									<th class="tableHeaderTags text-center" style="vertical-align: middle;">Bus Status</th>
							...
							<?php
								...
								<tr>
									...
									<td class="tableElementTagsNoHover text-center"><?php echo $busTicketsRow["busid"]; ?></td>
									...
									<td class="tableElementTagsNoHover text-center"><?php echo $busTicketsRow["status"]; ?></td>
