...
<html lang="en">
	...
	<head>
		...
		<title>BeeTraveller | Passengers</title>
		...
		<div class="col-sm-12 passengersWrapper">
		   ...
		   <div class="col-sm-2"></div>
			...
			<div class="col-sm-8">
				...
				<input type="text" class="inputPassengerName" name="name<?php echo $i; ?>" placeholder="Enter the full name of the passenger <?php echo $i; ?>" required/>
				<select class="inputSmall" name="gender<?php echo $i; ?>" title="Select Gender" required>
				...
				<div class="text-center">
                        ...
                        <input type="hidden" name="operatorHidden" value="<?php echo $operator; ?>">
